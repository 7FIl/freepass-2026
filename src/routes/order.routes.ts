...
router.post('/:canteenId', authenticate, orderController.createOrder.bind(orderController));
...
router.post('/:orderId/review', authenticate, orderController.createReview.bind(orderController));
